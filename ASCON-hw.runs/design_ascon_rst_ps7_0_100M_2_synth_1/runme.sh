...
HD_PWD='/home/monsud/Scrivania/ascon_project/ascon_project.runs/design_ascon_rst_ps7_0_100M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ascon_rst_ps7_0_100M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ascon_rst_ps7_0_100M_2.tcl
