...
HD_PWD='/home/monsud/Scrivania/ascon_project/ascon_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ascon_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_ascon_wrapper.tcl -notrace
