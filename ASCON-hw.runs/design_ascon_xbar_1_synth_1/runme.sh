...
HD_PWD='/home/monsud/Scrivania/ascon_project/ascon_project.runs/design_ascon_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ascon_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ascon_xbar_1.tcl
