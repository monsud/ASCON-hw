...
HD_PWD='/home/monsud/Scrivania/ASCON-hw/ASCON-hw.runs/design_ascon_ascon_core_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ascon_ascon_core_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ascon_ascon_core_0_4.tcl
