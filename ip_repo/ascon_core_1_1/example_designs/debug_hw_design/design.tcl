...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of ascon_core_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ascon_core_0/S00_AXI]
	connect_bd_net [get_bd_pins ascon_core_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ascon_core_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins ascon_core_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins ascon_core_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ascon_core_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	connect_bd_net [get_bd_pins ascon_core_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Copy all address to ascon_core_v1_1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ascon_core_v1_1_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ascon_core_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ascon_core_0_S_AXI_INTR_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ascon_core_v1_1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ascon_core_v1_1_hw_${i}"
