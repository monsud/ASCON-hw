...
compile()
{
  vlogan -work  $vlogan_opts +v2k +incdir+"../../../ASCON-hw.srcs/sources_1/new" \
  "../../../ip_repo/ascon_core_1_1/hdl/ascon_core_v1_1_S_AXI_INTR.sv" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work  $vlogan_opts -sverilog +incdir+"../../../ASCON-hw.srcs/sources_1/new" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ascon_core_v1_1 xil_defaultlib.glbl -o ascon_core_v1_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ascon_core_v1_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ascon_core_v1_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ascon_core_v1_1_simv.daidir vcs_lib c.obj)
