...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ascon_core_v1_1 xil_defaultlib.ascon_core_v1_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ascon_core_v1_1 -key {Behavioral:sim_1:Functional:ascon_core_v1_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ascon_core_v1_1.wdb xsim.dir libdpi.so)
