...
#
# Script generated by Vivado on Mon May 06 18:54:37 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ascon_core_v1_1.sh
...
#
# Usage        : ascon_core_v1_1.sh
#                ascon_core_v1_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ascon_core_v1_1.sh [-reset_run]
#                ascon_core_v1_1.sh [-reset_log]
#                ascon_core_v1_1.sh [-help]
#
...
#                script (type 'ascon_core_v1_1.sh -help' for more information).
#
...
design_libs_elab="-libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "ascon_core_v1_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ascon_core_v1_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work  $xmvlog_opts +incdir+"../../../ASCON-hw.srcs/sources_1/new" \
  "../../../ip_repo/ascon_core_1_1/hdl/ascon_core_v1_1_S_AXI_INTR.sv" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work  $xmvlog_opts -sv +incdir+"../../../ASCON-hw.srcs/sources_1/new" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ascon_core_v1_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ascon_core_v1_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ascon_core_v1_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ascon_core_v1_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ascon_core_v1_1.sh [-help]\n\
Usage: ascon_core_v1_1.sh [-step]\n\
Usage: ascon_core_v1_1.sh [-lib_map_path]\n\
Usage: ascon_core_v1_1.sh [-reset_run]\n\
Usage: ascon_core_v1_1.sh [-reset_log]\n\
Usage: ascon_core_v1_1.sh [-keep_index]\n\
Usage: ascon_core_v1_1.sh [-noclean_files]\n\n\
