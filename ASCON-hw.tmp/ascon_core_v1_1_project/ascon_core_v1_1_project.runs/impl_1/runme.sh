...
HD_PWD='/home/monsud/Scrivania/ASCON-hw/ASCON-hw.tmp/ascon_core_v1_1_project/ascon_core_v1_1_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ascon_core_v1_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ascon_core_v1_1.tcl -notrace
