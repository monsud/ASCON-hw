...
HD_PWD='/home/monsud/Scrivania/ASCON-hw/ASCON-hw.tmp/ascon_core_v1_1_project/ascon_core_v1_1_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascon_core_v1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascon_core_v1_1.tcl
