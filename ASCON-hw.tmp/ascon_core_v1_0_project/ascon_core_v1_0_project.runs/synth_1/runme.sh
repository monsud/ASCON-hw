...
HD_PWD='/home/monsud/Scrivania/ASCON-hw/ASCON-hw.tmp/ascon_core_v1_0_project/ascon_core_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascon_core_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascon_core_v1_0.tcl
